      ...
      <div className="teamLead">
        ...
        <div className="teamText">
          ...
          <p>
            ...
            strategic brand consulting. She is a Communication Strategist at
            PoliFIX Inc. She is also leading communications at V4C
            (Volunteers4Cause) Abuja Chapter, volunteering as a Social Media
            Manager for TEDxMaitama, served as a Librarian at the Centre for
            Democracy and Development (CDD) and has interned with Daar
            Communications PLC. Skilled in strategic communication, media/public
            relations, brand consulting, creative storytelling, brand consulting
            and copywriting, she thrives at building meaningful connections and
            shaping narratives that inspire action. A Library and Information
            Science graduate from Ahmadu Bello University, Zaria, and an alumna
            of Enactus ABU, Ummi-Khulsum is driven by the belief that effective
